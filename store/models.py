...
class Good(Item):
    ...
    item_type = models.CharField(max_length=64) # raw material, finished product
    ...
    categories = models.ManyToManyField('GoodCategory', through='GoodCategories', through_fields=('good', 'category'))
